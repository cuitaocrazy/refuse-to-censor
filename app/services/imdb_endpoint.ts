...
// from: https://github.com/amilajack/themoviedb/blob/master/src/endpoints.js
...
// function getMethod<
//   C extends keyof typeof endpoint.methods,
//   M extends keyof typeof endpoint.methods[C],
// >(category: C, method: M) {
//   return endpoint.methods[category][method]
// }

export function getApiParams<
  C extends keyof typeof endpoint.methods,
  M extends keyof typeof endpoint.methods[C],
>(category: C, method: M, params: URLSearchParams) {
  const info = endpoint.methods[category][method] as {
    resource: string
    method: string
  }
  ...
  return {
    url: endpoint.base_url + resource + '?' + urlParams,
    method: info.method,
  }
}
